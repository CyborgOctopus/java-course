/*
I received some help with saving projects as templates from the following sources:
...
public class R2PlusPlus extends R2 {
     ...
     * variable. There is an option to automatically clear the 'currentActionSequence' variable so that prior
     * recorded information will not accidentally be included in the action sequence.
     * <p>
     * Precondition: An instance of the R2PlusPlus class has been created.
     * <p>
     * Postcondition: The 'recordActions' variable has been set to true. If 'autoClear' is true, the current action
     * sequence has been cleared in preparation for the recording.
     */
    public void startRecordingActions(boolean autoClear) {
        if (autoClear) {
            this.clearCurrentActionSequence();
        }
